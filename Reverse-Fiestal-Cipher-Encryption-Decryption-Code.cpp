...
vector<int> FiestalCipherDecryption(vector<int> cipherText, vector<int> key2, vector<int> key1){
    swapping(cipherText);
    vector<int> midText=roundFiestalCipher(cipherText,key2);
    vector<int> plainText=roundFiestalCipher(midText,key1);
    swapping(plainText);
    return (plainText);
...
vector<int> fiestalCipherEncryption(vector<int> plainText, vector<int> key1, vector<int> key2){
    ...
    vector<int> midText=roundFiestalCipher(plainText,key1);
    
    vector<int> cipherText=roundFiestalCipher(midText,key2);
    return cipherText;
}
